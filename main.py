...
async def get_rutina_hoy():
    ...
    try:
        ...
        system_instruction = (
            ...
            "1. Distribución Semanal: La meta ideal es realizar entre 2 y 3 sesiones de Fuerza de alta intensidad (enfocadas en tren inferior/glúteos y glúteo medio) y de 1 a 2 sesiones de Carrera demandantes por semana, con al menos 1-2 días completos de descanso.\n"
            ...
            "- Las sesiones de Carrera deben ser retadoras: entrenamiento de intervalos intensivos (ej: 6-8 series de 90s a velocidad máxima + 45s de descanso activo trotando), fartleks o carreras de ritmo sostenido largo (30-40 minutos).\n\n"
